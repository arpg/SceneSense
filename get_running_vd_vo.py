...
local_occ_running_arr = []
local_diff_running_arr = []
...
# step += 1
    ...
    local_occ_running_arr.append(num_local_occ)
    local_diff_running_arr.append(num_diff_point)


np.savetxt("local_oc_h2.txt", np.array(local_occ_running_arr))
np.savetxt("local_diff_h2.txt", np.array(local_diff_running_arr))