...
o3d.io.write_point_cloud("/hdd/sceneDiff_data/combined_image_data_house_2/diff/" "pointcloud_" + str(curr_dir)+ ".pcd", pcd_inpaint)
...
for i, img in enumerate(np.asarray(inpained_pm[0])):
    ...
    cv2.imwrite("/hdd/sceneDiff_data/combined_image_data_house_2/diff/" + str(curr_dir) + "_" + str(i) + ".png", output )
