...
diff_path = "/hdd/sceneDiff_data/house_1/step_" + str(step) + "/diffused_pc_30.pcd"
#for house 2:
# diff_path = "/hdd/sceneDiff_data/combined_image_data_house_1/diff/pointcloud_" + str(step) + ".pcd"
running_occ_path = "/hdd/sceneDiff_data/house_1/step_" + str(step) + "/running_octomap/running_occ.pcd"
#ground truth
#load the gt data
gt_file_path = '/home/arpg/Documents/habitat-lab/running_octomap/gt_occ_point.pcd'
gt_pcd = o3d.io.read_point_cloud(gt_file_path)
#load the pose data
curr_coor = np.loadtxt( "/hdd/sceneDiff_data/house_1/step_" + str(step) + "/running_octomap/curr_pose.txt")
curr_rot = np.loadtxt( "/hdd/sceneDiff_data/house_1/step_" + str(step) + "/running_octomap/curr_heading.txt")
...
o3d.visualization.draw_geometries([local_occ_vox, diff_vox, coor])